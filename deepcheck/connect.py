"""Native cognis-connect emit for deepcheck — forward findings to any platform.

Maps deepcheck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    deepcheck ... --format json | deepcheck-emit --to stix
    deepcheck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
